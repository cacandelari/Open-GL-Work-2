...
public:
  ...
  void setColor(int x, int y, double r, double g, double b) {
    ...
    p->red = (uint8_t)(r * 80);//255
    p->green = (uint8_t)(g * 150);
    p->blue = (uint8_t)(b * 220);
	//changing these values changes the color of the entire image
  }
  /*This set color function may be able to be repurposed and 
  used in the Sphere and Triangle headers to change
  their color
  */
